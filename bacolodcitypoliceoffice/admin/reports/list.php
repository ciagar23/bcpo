...
{
$query ="of_station='".$department."' and";
}
...
$sql = "SELECT of_id, of_bl_id, of_name, of_aka, of_alias, of_address, of_casestatus, of_gender, of_height, of_weight, of_birthplace, of_birthdate, of_haircolor, of_occupation, of_mark, of_gang, of_influence, of_disposition, of_nat,of_age
        FROM tbl_offender
		WHERE $query of_datetime >= '$from' and of_datetime <= '$to'
...
<table width="2022" height="250" border="0" class="entryTable">
...
?>
  	<tr> 
   		<td colspan="22" align="center">Reports return zero result</td>
  	</tr>
  <?php
}
?>
...
<p>&nbsp;</p>
  ...
  &nbsp;&nbsp;<input name="btnModifyBlotter" type="button" id="btnModifyBlotter" value="Print" onClick="window.location.href='listnew.php?view=listprint&txtfrom=<? echo $from;?>&txtto=<? echo $to?>';" class="box"><input type="button" value="Back" onclick="window.history.back();" />
  &nbsp;&nbsp;