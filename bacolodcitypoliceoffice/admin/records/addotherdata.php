...
bl_dtg, bl_cnat, bl_rdrugs, bl_ralc, bl_runc, bl_rfa, bl_rnat, bl_brgy, bl_prosec, bl_court, bl_crime, bl_cstatus, bl_rstatus, bl_rblunt, bl_calias, bl_coccupation, bl_rbladed, bl_rhands, bl_rpoison, bl_trkind, bl_trmodel, bl_trplateno, bl_trmotorno, bl_trregno, bl_trchasisno, bl_trmakeyear, bl_cbirthdate,bl_statusofcase, bl_fakind, bl_famake, bl_facaliber, bl_faserial, bl_falicense
...
<table width="100%"  border="0" align="center" cellpadding="14">
  	...
  	<tr>
    	<td align="center" valign="top">
			...
			<table width="60%" border="0">
      			<tr>
        			<td colspan="2" class="entryTable2"> COMPLAINANT'S DATA: </td>
        		</tr>
				...
				<tr>
					<td colspan="2"><font color="#000066" face="Verdana, Arial, Helvetica, sans-serif"><b>CASE INFORMATION</b> </td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;  </td>
				</tr>
