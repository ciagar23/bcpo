...
$sql = "SELECT user_station
	...
	$sql1 = "SELECT bl_id
		...
		$sql   = "INSERT INTO tbl_history (h_date, h_user, h_action, h_station, h_link, h_category)
	          VALUES (NOW(), '$blottedby', 'Added Blotter no. $bl_id', '$station','/bacolodcitypoliceoffice/admin/blotter/index.php?view=detail&policeId=$bl_id', 'blotter')";
	dbQuery($sql);
...
extract($row2);
	...
	$sql   = "INSERT INTO tbl_history (h_date, h_user, h_action, h_station, h_link,h_category)
	          VALUES (NOW(), '$blottedby', 'Recase Blotter no. $bl_id', '$station','/bacolodcitypoliceoffice/admin/blotter/index.php?view=detail&policeId=$policeId','blotter')";
	dbQuery($sql);
