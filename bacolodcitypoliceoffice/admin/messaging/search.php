...
<table border="0" cellspacing="2">
	...
	<tr>
		...
		<td><input name="search" type="text" class="box" id="txtsearch" size="40" maxlength="100"></td>
  		<td><input type="image" src='/bacolodcitypoliceoffice/admin/include/design/search.gif' class="box"></td>
   		<td><a href="<? echo $link;?>"><img src='/bacolodcitypoliceoffice/admin/include/design/addblotter.gif' border=0></a></td>
	</tr>
