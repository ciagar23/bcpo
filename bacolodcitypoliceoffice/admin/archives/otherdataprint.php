...
window.print()
window.close()
window.location ='index.php?view=otherdata&policeId=<?php echo $policeId; ?>';
...
$sql   = "INSERT INTO tbl_history (h_date, h_user, h_action, h_station, h_link, h_category)
	          VALUES (NOW(), '$fullname', 'Printed Blotter no. $policeId', '$station', '/bcpo/admin/blotter/index.php?view=otherdata&policeId=$policeId', 'blotter')";
	dbQuery($sql);
