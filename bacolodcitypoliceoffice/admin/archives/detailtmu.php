...
<article class="module width_full">
 ...
 <input name="btnAddBlotter" type="button" id="btnAddBlotter" value="View Other Data" onClick="window.location.href='index.php?view=otherdatatmu&policeId=<? echo $policeId;?>';" class="box">
