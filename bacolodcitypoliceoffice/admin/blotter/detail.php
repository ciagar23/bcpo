...
<article class="module width_full">
			<header><h3>Complainant</h3></header>
 ...
 <table width="100%" border="0" align="center"  class="detail">
  ...
  <tr class='row1'> 
   ...
   <tr class='row2'>
   <td class="content"  colspan="2" align="center" ><div align="justify"> <?php echo nl2br($bl_outline); ?></div></td>
  </tr>
  <tr class='row1'> 
   <td  colspan="2">&nbsp;</td>
  </tr>
 ...
 <input name="btnAddBlotter" type="button" id="btnAddBlotter" value="Certificate" onClick="window.location.href='index.php?view=certificate&policeId=<? echo $policeId;?>';" class="box">
