...
<article class="module width_full">
 ...
 <table width="100%" border="0" align="center"  class="detail">
  ...
  <tr class='row1'> 
   <td class="label2" width="187" ><strong>Investigator</strong></td>
 ...
 <input name="btnAddBlotter" type="button" id="btnAddBlotter" value="Add Other Data" onClick="window.location.href='<? echo $link;?>';" class="box"> <input name="btnAddBlotter" type="button" id="btnAddBlotter" value="View Other Data" onClick="window.location.href='index.php?view=otherdatatmu&policeId=<? echo $policeId;?>';" class="box">
