...
<form action="processBlotter.php?action=addBlotter" method="post" enctype="multipart/form-data" name="frmAddBlotter" id="frmAddBlotter">
  <table width="100%"  border="0" align="center">
	...
	Type of Vehicle: <?php echo $bl_vehicle; ?>  </td>
</table>
<table align="center">
<tr>
...
<td><img src="<?php echo $bl_tmupic4; ?>" width="350">
 ...
 <p align="center"> 
  ...
  <input name="btnModifyBlotter" type="button" id="btnModifyBlotter" value="Modify Data" onClick="window.location.href='index.php?view=addotherdatatmu&policeId=<?php echo $policeId; ?>';" class="box">
  &nbsp;&nbsp;
