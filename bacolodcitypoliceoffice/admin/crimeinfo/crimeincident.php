<article class="module width_full">
        ...
        <a href='<?php echo WEB_ROOT;?>website/crimeinfo/index.php?view=crimeincident'> Statistic</a> ||
  <a href='<?php echo WEB_ROOT;?>admin/crimeinfo/index.php?view=crimerate'>Crime Rate</a></h3>
		</header>
