...
<p>&nbsp;</p>
 ...
 <p align="center">
   <input name="btnBack" type="button" id="btnBack" value=" Modify " onClick="window.location.href='index.php?view=aboutbcpoedit';" class="box">
