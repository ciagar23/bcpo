...
$sql = "SELECT rl_id, r_id, rl_crime, rl_date, rl_place, rl_ccisnr, rl_branch, rl_status, rl_uploadedby
...
<form action="processRogue.php?action=addProduct" method="post"  name="frmListProduct" id="frmListProduct">
 <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
  <tr> 
   <td  colspan="7" class="box"><strong>CRIME</strong></td>
  </tr>
  <tr  class="entryTable" bgcolor="#999999"> 
...
?>
  <tr <?php echo $bgcolor;?> > 
   ...
   <td align="left"><font color="#FF0000"><?php echo $rl_uploadedby; ?></td>
  </tr>
  <?php
	} // end while
?>
...
?>
  <tr> 
   <td colspan="7" align="center">No crime Yet</td>
  </tr>
  <?php
}
?>
