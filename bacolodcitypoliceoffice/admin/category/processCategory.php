...
function addCategory()
{
    ...
    $sql   = "INSERT INTO tbl_category (c_parent_id, c_name, c_description, c_image) 
...
function modifyCategory()
{
    ...
    $sql    = "UPDATE tbl_category 
               SET c_name = '$name', c_description = '$description', c_image = $catImage
               WHERE c_id = $catId";
...
function _deleteImage($catId)
{
    ...
    if (dbNumRows($result)) {
        while ($row = dbFetchAssoc($result)) {
    	    ...
    	    $deleted = @unlink(SRV_ROOT . CATEGORY_IMAGE_DIR . $row['c_image']);
		}	
    }
